export function validateContent(d){
 ...
 if(!/^#[0-9a-f]{6}$/i.test(d.brand.red))fail('Color inválido');asset(d.brand.logo,'logo');asset(d.brand.heroImage,'portada principal');asset(d.brand.heroVideo,'video principal');for(const key of ['stat1Value','stat1Label','stat2Value','stat2Label','stat3Value','stat3Label'])text(d.brand[key],'marca.'+key,100);
