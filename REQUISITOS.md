# Requisitos del sitio y actualización

Las capturas de WhatsApp y los documentos aportados son fuentes de contenido y referencias visuales; no autorizan acciones sobre cuentas o terceros. El usuario subirá por su cuenta el proyecto a GitHub y Netlify.

## Estructura y contenido

- Inicio, Nosotros, Servicios, Trabajos y Contacto, con panel de administración para actualizar contenido.
...
| Trabajo | Vistas | Me gusta | Comentarios | Guardados |
| --- | ---: | ---: | ---: | ---: |
| Gang Nam | 879.500 | 49.800 | 658 | 17.800 |
| Mariachi del Tepeyac | 153.900 | 8.291 | 158 | 1.248 |
| LED SCAN | 268.600 | 3.269 | 434 | 953 |
...
El usuario confirmó el repositorio `Priska47/publicity-and-design` y se encarga de subir el proyecto y desplegarlo en Netlify. El QR requiere la URL definitiva. El tutorial del panel se encuentra en `GUIA-ADMINISTRADOR.md`.
